...
public class SemanticAnalyzer extends VisitorAdaptor {
    ...
    public void visit(DesIdent des) {
		...
		if(des.obj.getKind() == Obj.Con)
			report_info("Koristi se konstanta: " + des.getName() , des);
    	else if(des.obj.getKind() == Obj.Var) {
    		if(des.obj.getType().getKind() == Struct.Array)
    			report_info("Koristi se element niza: " + des.getName() , des);
    		else
    			report_info("Koristi se promjenljiva: " + des.getName() , des);
    	}
	}
    ...
    public void visit(DesNsIdent dni) {
    	...
    	if(dni.obj.getKind() == Obj.Con)
    		report_info("Koristi se konstanta: " + dni.getNsName()+"::"+ dni.getName() , dni);
    	else if(dni.obj.getKind() == Obj.Var) {
    		if(dni.obj.getType().getKind() == Struct.Array)
    			report_info("Koristi se element niza: " + dni.getNsName()+"::"+ dni.getName() , dni);
    		else
    			report_info("Koristi se promjenljiva: " + dni.getNsName()+"::"+ dni.getName() , dni);
    	}
    }
